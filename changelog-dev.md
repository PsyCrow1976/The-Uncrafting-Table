...
- Moved the recipe cycle button ~25px to the right of the preview grid corner
...
## 0.0.0.1 — Initial development build

First development build of The Uncrafting Table for Minecraft 26.1.2 / NeoForge 26.1.2.76.
